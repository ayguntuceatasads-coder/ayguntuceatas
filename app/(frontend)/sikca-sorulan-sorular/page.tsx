...
import { Home, ChevronRight, Plus, Minus, MessageCircleQuestion, Loader2 } from "lucide-react";
...
export default function SSSPage() {
  ...
  // Veritabanından soruları sıralamasına göre çekiyoruz
  useEffect(() => {
              ...
              {faqs.map((faq, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Cevap Kısmı (whitespace-pre-wrap ile paragraf boşlukları korundu) */}
                    <div 
