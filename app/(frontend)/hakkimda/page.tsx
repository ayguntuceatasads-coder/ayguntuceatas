...
// YENİDEN DOĞRULAMA (Sayfanın hızlı çalışması ve güncel kalması için)
export const revalidate = 60;

// 1. ZENGİNLEŞTİRİLMİŞ METADATA (Google Arama Sonuçları İçin)
export const metadata: Metadata = {
  title: "Hakkımda | Uzm. Psk. Aygün Tuçe Ataş Önç",
  description: "Uzm. Psk. Aygün Tuçe Ataş Önç'ün 23 yılı aşkın klinik deneyimi, akademik geçmişi, uluslararası terapi sertifikasyonları ve kongreleri hakkında detaylı bilgi.",
  keywords: ["Aygün Tuçe Ataş Önç", "Antalya Psikolog", "Klinik Psikolog Özgeçmiş", "EMDR Terapisti", "Psikolog Hakkında"],
  openGraph: {
    title: "Uzm. Psk. Aygün Tuçe Ataş Önç | Hakkımda",
    description: "23 yılı aşkın klinik deneyimi, akademik geçmişi ve uzmanlık alanları.",
  ...
  alternates: {
    canonical: "https://www.ayguntuceatas.com/hakkimda",
  }
};
...
export default async function AboutPage() {
  ...
  // 2. GOOGLE SCHEMA (JSON-LD) - Uzman Kişi (Person/Physician) İşaretlemesi
  const personSchema = {
    "@context": "https://schema.org",
    "@type": ["Person", "Physician"],
    "name": about?.profile_title || "Aygün Tuçe Ataş Önç",
    "jobTitle": about?.profile_subtitle || "Uzman Klinik Psikolog",
    "image": profileImg,
    "url": "https://www.ayguntuceatas.com/hakkimda",
    "description": "23 yılı aşkın klinik deneyimi ile Antalya'da online ve yüz yüze psikoterapi, EMDR terapisi hizmetleri veren uzman klinik psikolog.",
    "worksFor": {
      "@type": "MedicalClinic",
    ...
    "knowsAbout": clinicalAreas.length > 0 ? clinicalAreas.map((item: any) => typeof item === 'string' ? item : item.title) : ["Klinik Psikoloji", "Psikoterapi", "EMDR Terapisi"]
  };
              ...
              <div className="w-full lg:w-[35%] shrink-0">
                <div className="relative w-full aspect-[4/5] rounded-3xl overflow-hidden shadow-lg border border-slate-100 group bg-slate-50">
                  ...
                  <div className="absolute bottom-8 left-0 right-0 text-center px-6">
                    ...
                    <h2 className="text-white text-3xl font-bold drop-shadow-md">{about?.profile_title || "Aygün Tuçe Ataş"}</h2>
                  </div>
                </div>
              </div>
